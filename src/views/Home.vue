  ...
  <div class="select package">
    ...
    <ul class="property-list">
      <li class="property-list__item" v-for="(property, index) in properties" :key="property.id">
          ...
          <div class="right-side">
            <div class="catering">
              ...
              <div class="catering-checkbox">
                <i class="fas fa-check" :style="{ color: property.catering ? 'green' : 'transparent' }"></i>
              </div>
            ...
            <table class="price">
              ...
              <tr class="price-extras">
                ...
                <td class="count">${{ property.extras }}</td>
              </tr>
        ...
        <div class="property-extras" v-if="property.addExtras">
...
export default {
  ...
  methods: {
    totalPrice(property) {
      return property.price + property.extras
    }
  }
}
</script>
